...
def generate_password(mode="balanced"):
    ...
    if mode == "memorable":
        # Small built-in word list to avoid external dependencies
        WORD_LIST = [
            "river", "coffee", "purple", "forest", "solar", "magnet",
            "planet", "lucky", "orange", "island", "silver", "falcon",
            "breeze", "mountain", "echo", "shadow", "crystal", "ember"
        ]
